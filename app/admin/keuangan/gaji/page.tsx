...
import {
  ...
  type FinancialBill,
} from "@/services/admin/financial-bill.service";
                  ...
                  filteredData.map((item) => (
                    <tr key={item.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <ActionsGroup handleDetail={() => handleDetail(item)} />
                      </td>
      ...
      {financialBillData && (
        <div className="flex items-center justify-between">
          <div className="text-sm text-gray-700">
            Menampilkan {financialBillData.from} sampai {financialBillData.to}{" "}
            dari {financialBillData.data.length} data
          </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {selectedItem.pinjaman_reference}
                      </p>
                    </div>
                    <div>
                      <Label className="font-medium">Nominal Pinjaman</Label>
                      <p className="text-sm text-gray-600">
                        {formatCurrency(selectedItem.pinjaman_nominal)}
                      </p>
                    </div>
                    <div>
                      <Label className="font-medium">Bunga (%)</Label>
                      <p className="text-sm text-gray-600">
                        {selectedItem.pinjaman_interest_rate}%
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {formatCurrency(
                          selectedItem.pinjaman_monthly_principal
                        )}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {formatCurrency(selectedItem.pinjaman_monthly_interest)}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="text-sm font-medium text-gray-900">
                        {formatCurrency(
                          selectedItem.pinjaman_monthly_installment
                        )}
                      </p>
                    </div>
                    <div>
